...
public class SecondaryChatBarPanel extends javax.swing.JPanel {

    
    public SecondaryChatBarPanel(String text) {
        initComponents();
    ...
    private void initComponents() {
        ...
        chatTextField.setBackground(new java.awt.Color(102, 102, 102));
