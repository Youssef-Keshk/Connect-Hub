...
public class UserContentPanel extends javax.swing.JPanel {
    ...
    public UserContentPanel(String username, String profilePath, String imagePath, LocalDateTime time, String text) {
        
        initComponents();
        //setBorder(BorderFactory.createLineBorder(Color.BLUE));
        setLabels(username, profilePath, imagePath, time, text);
    }
    
    public void setLabels(String username, String profilePath, String imagePath, LocalDateTime time, String text) {
