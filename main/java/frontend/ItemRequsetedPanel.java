...
public class ItemRequsetedPanel extends javax.swing.JPanel {
    ...
    public ItemRequsetedPanel(User user, MainFrame parent) {
        this.parent = parent;
    ...
    private void showManagePanel(){
        try {
            // Create the dialog
            JDialog dialog = new JDialog((Frame) null, "Manage Requests", true); // Modal dialog
            dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);

            // Create and set up the ManageRequestedPanel
            ManageRequestedPanel manageRequestedPanel = new ManageRequestedPanel(parent.getUser().getUserId(), userID, parent.getFriendshipManager(), dialog);
            dialog.setLayout(new BorderLayout());
            dialog.add(manageRequestedPanel, BorderLayout.CENTER);
